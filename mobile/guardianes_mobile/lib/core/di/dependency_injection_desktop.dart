...
import '../../features/step_tracking/data/datasources/step_tracking_remote_data_source_desktop.dart' as desktop;
...
class DependencyInjectionDesktop {
  ...
  static void initialize() {
    ...
    // Data Sources
    _stepTrackingRemoteDataSource = desktop.StepTrackingRemoteDataSourceDesktopImpl(_apiClient);
