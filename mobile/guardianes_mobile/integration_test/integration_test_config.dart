...
class IntegrationTestConfig {
  ...
  static bool get verboseLogging => 
      const String.fromEnvironment('VERBOSE_TESTS', defaultValue: 'false') == 'true';
      
  static bool get skipSlowTests => 
      const String.fromEnvironment('SKIP_SLOW_TESTS', defaultValue: 'false') == 'true';
}
...
class TestKeys {
  ...
  static const String guardianConfirmPasswordField = 'guardian_confirm_password_field';
