...
void main() {
  group('Guardianes Mobile Performance Tests', () {
    ...
    test('App startup performance', () async {
      ...
      expect(startupFrames, lessThan(600),
          reason: 'App should start in reasonable time');
    });
    ...
    test('Home screen navigation performance', () async {
      try {
        ...
        final timeline = await driver.traceAction(() async {
          ...
          try {
            await driver.waitFor(bottomNavFinder,
      ...
      try {
        ...
        final timeline = await driver.traceAction(() async {
          try {
            ...
            await driver.scroll(
                scrollableFinder, 0, -300, const Duration(milliseconds: 500));
