...
public class Guardian {
    ...
    public Guardian(String username, String email, String passwordHash, String name, LocalDate birthDate) {
    ...
    public Guardian(Long id, String username, String email, String passwordHash, String name, 
                   LocalDate birthDate, GuardianLevel level, int experiencePoints, int totalSteps, 
                   int totalEnergyGenerated, LocalDateTime createdAt, LocalDateTime lastActiveAt, boolean active) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.passwordHash = passwordHash;
