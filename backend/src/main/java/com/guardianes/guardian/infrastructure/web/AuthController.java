...
public class AuthController {
  ...
  @Operation(
      ...
      description = "Creates a new Guardian account and returns authentication token")
  public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest request) {
    try {
      GuardianRegistrationRequest registrationRequest =
      ...
      GuardianAuthResponse authResponse =
          guardianApplicationService.registerGuardian(registrationRequest);
  ...
  @Operation(
      ...
      description = "Authenticates Guardian and returns authentication token")
  public ResponseEntity<?> login(@Valid @RequestBody LoginRequest request) {
    GuardianLoginRequest loginRequest =
        new GuardianLoginRequest(request.getUsernameOrEmail(), request.getPassword());

    Optional<GuardianAuthResponse> authResponse =
        guardianApplicationService.loginGuardian(loginRequest);
