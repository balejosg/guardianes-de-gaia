...
public class EnergyController {
    ...
    @Operation(
        ...
        description = "Retrieve the current energy balance and recent transaction summary for a guardian."
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Energy balance retrieved successfully",
    ...
    @Operation(
        ...
        description = "Spend energy for battles, challenges, or shop purchases. Validates sufficient balance before spending."
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Energy spent successfully",
    ...
    public ResponseEntity<EnergySpendingResponse> spendEnergy(
            @Parameter(description = "Guardian ID", required = true) @PathVariable Long guardianId,
            @Parameter(description = "Energy spending details", required = true) @Valid @RequestBody EnergySpendingRequest request) {
