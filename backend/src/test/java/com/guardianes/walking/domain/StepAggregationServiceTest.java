...
class StepAggregationServiceTest {
    ...
    void shouldAggregateDailyStepsForGuardian() {
        ...
        List<StepRecord> stepRecords = Arrays.asList(
        ...
        when(stepRepository.findByGuardianIdAndDate(guardianId, date))
    ...
    void shouldGetStepHistoryForGuardian() {
        ...
        List<DailyStepAggregate> expectedHistory = Arrays.asList(
        ...
        // When
        List<DailyStepAggregate> result = stepAggregationService.getStepHistory(guardianId, fromDate, toDate);
        ...
        verify(stepRepository, times(1)).findDailyAggregatesByGuardianIdAndDateRange(guardianId, fromDate, toDate);
    }
}