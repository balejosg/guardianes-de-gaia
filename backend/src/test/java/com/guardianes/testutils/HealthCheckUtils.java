...
public class HealthCheckUtils {
    ...
    public static void validateActuatorEndpoints(
        ...
        for (String endpoint : endpoints) {
            ...
            assertEquals(
                    200, response.statusCode(), "Endpoint " + endpoint + " should be accessible");
        }
    }
    ...
    public static void validateAuthentication(HttpClient client, GenericContainer<?> backend)
        ...
        assertEquals(
                401, unauthResponse.statusCode(), "Unauthenticated requests should be rejected");
    ...
    public static void validateExternalServiceConnectivity(
        ...
        assertFalse(
                logs.contains("Connection refused"), "Should not have connection refused errors");
    ...
    public static void validateNoStartupErrors(GenericContainer<?> backend) {
        ...
        assertFalse(
                logs.contains("TomcatMetricsBinder"), "Should not have TomcatMetricsBinder issues");
    }
    ...
    public static void validatePerformance(
        ...
        assertTrue(
                apiTime < 10000,
                "API endpoint should respond within 10 seconds, took: " + apiTime + "ms");
    }
    ...
    public static void validateMonitoringIntegration(
        ...
        assertEquals(
                200, prometheusResponse.statusCode(), "Prometheus endpoint should be accessible");
