 ...
 *
 * <p>IMPORTANT: All container factory methods return containers that should be used with @Container
 * annotation for proper lifecycle management. TestContainers framework automatically handles
 * start/stop/cleanup when used with annotations.
 */
public class DockerTestUtils {

  /**
   * Creates a standard MySQL test container with guardianes database. Note: Caller is responsible
   * for proper resource management. Use with @Container annotation for automatic lifecycle
   * management.
   */
