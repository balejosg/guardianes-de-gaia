...
class GuardianAuthenticationServiceTest {
  ...
  void shouldFailAuthenticationWithInactiveGuardian() {
    ...
    Guardian inactiveGuardian =
        createInactiveTestGuardian(1L, username, "test@example.com", hashedPassword);
  ...
  void shouldChangePasswordSuccessfully() {
    ...
    Guardian guardian =
        createTestGuardian(guardianId, "testuser", "test@example.com", currentHashedPassword);
      ...
      assertThrows(
          ...
          () ->
              authenticationService.changePassword(
                  guardianId, currentPassword, invalidNewPassword));
    }
  }
  ...
  private Guardian createInactiveTestGuardian(
